    ...
    public string GetBindingText(Binding binding) {
        switch (binding) {
            ...
            case Binding.InteractAlternate:
                return playerInputActions.Player.InteractAlternatte.bindings[0].ToDisplayString();
            case Binding.Pause:
                return playerInputActions.Player.pause.bindings[0].ToDisplayString();
            case Binding.Gamepad_Interact:
                return playerInputActions.Player.Interact.bindings[1].ToDisplayString();
            case Binding.Gamepad_InteractAlternate:
                return playerInputActions.Player.InteractAlternatte.bindings[1].ToDisplayString();
    ...
    public void RebindBinding(Binding binding, Action onActionRebound) {
        ...
        switch (binding) {
            ...
            case Binding.Interact:
                ...
                break;
            case Binding.InteractAlternate:
                inputAction = playerInputActions.Player.InteractAlternatte;
                bindingIndex = 0;
                break;
            case Binding.Pause:
